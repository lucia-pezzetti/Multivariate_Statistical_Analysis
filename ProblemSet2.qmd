...
tibble("rank"=1:9, "arithmetic mean of errors"=error44, "misclassification rate"=mis_rate44)
```
...
```{r}
data.frame("Arithmetic average of errors"=mlog.err, "Misclassification rate"= mlog.mis)
```
...
data.frame("Arithmetic average of errors" = rfor.err, "Misclassification rate" = rfor.mis) 
```
