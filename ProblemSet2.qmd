...
tibble("rank"=1:9, "simple error"=error44, "weighted error"=error44_w)
```
...
Which have decresed by a factor of $\frac{1}{10}$ compared to the LDA ones. MAYBE IT'S BETTER TO IMPLEMENT IT BY HAND TO SHOW IT'S THE SAME PROCEDURE?

MISSING: LOGISTIC REGRESSION, RANDOM FOREST
