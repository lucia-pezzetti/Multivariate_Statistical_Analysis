...
dataf=data.frame("rank" = as.character(9:1), "arithmetic_mean" = error44[9:1], "weighted_mean" = mis_rate44[9:1])
dataf <- melt(dataf)
...
data.frame("k"=1:aux, "Arithmetic average of errors" = knn.err, "Misclassification rate" = knn.mis) 
```
