...
In order to have a further check on the multivariate gaussianity, we perform for each digit a statistical test. The null hypothesis is the multivariate gaussianity.
```{r}
